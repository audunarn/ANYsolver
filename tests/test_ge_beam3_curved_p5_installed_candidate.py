...
def test_offline_wheel_two_fresh_process_checks(tmp_path):
    ...
    shutil.copy2(root/'docs/reference_cases/ge_beam3_curved_p5_installed_smoke.py',script)
    source_map.write_text((root/'docs/reference_cases/ge_beam3_curved_p5_package_source_map.json').read_text(encoding='utf-8'),
    ...
    receipt = dict(schema='GE_BEAM3_P5_DISPOSABLE_PACKAGE_TEST_RECEIPT_V1',
