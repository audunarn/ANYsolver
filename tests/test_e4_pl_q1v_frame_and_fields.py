...
RAW = [
    ROOT / "docs/reference_cases/e4_pl_q1v_reference_raw.json",
    ROOT / "docs/reference_cases/e4_pl_q1v_oracle_raw.json",
]
...
def test_q1v_all_56_numbered_frames_and_field_work() -> None:
    payload = _payload()
    ...
    assert payload["schema"] == "e4_pl_q1v_common_certificate_payload_v1"
