...
def _payload() -> dict[str, object]:
    path = ROOT / "docs/reference_cases/e4_pl_q1u_reference_raw.json"
...
def test_q1u_actual_38_field_condensation_rank_and_rigid_modes() -> None:
    payload = _payload()
    ...
    if failed:
        assert terminal == "NO_GO_E4_PL_Q1U_LOCAL_ALGEBRA"
    elif local["unresolved_at_1024"]:
        assert terminal == "UNCLASSIFIED_E4_PL_Q1U_LOCAL_PLANAR_IDENTITY"
