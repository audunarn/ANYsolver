...
def test_q1t_evidence_terminal_and_cross_implementation_contract() -> None:
    reference, reference_raw = _load("e4_pl_q1t_reference_raw.json")
    oracle, oracle_raw = _load("e4_pl_q1t_oracle_raw.json")
    agreement, agreement_raw = _load("e4_pl_q1t_agreement.json")
    output, _ = _load("e4_pl_q1t_output.json")
    ...
    for key, raw, impl in (("reference", reference_raw, "Q1T_REFERENCE_STDLIB_FIELD_ALG"), ("oracle", oracle_raw, "Q1T_ORACLE_SYMPY_ALGEBRAIC_FIELD")):
        row = agreement[key]
