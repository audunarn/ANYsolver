...
REVIEW_SCHEMA = "anysolver.e4-pl-s3-qualification-independent-review-v3"
AUTHORITY_SUBJECT = "docs: authorize optimized S3 qualification execution"
...
REQUIRED_REVIEWER_IDS = (
    "s3-v3-authority-reviewer",
    "s3-v3-science-reviewer",
)
STRUCTURAL_WORKERS = (
    "STRUCTURAL_SLASH",
...
BINDING_GENERATOR_IDENTITY = {
    ...
    "sha256": "89035EC0787F6DC21B6D37478EC11A983A668F59216C73CC68820A1AB4F7247D",
}
