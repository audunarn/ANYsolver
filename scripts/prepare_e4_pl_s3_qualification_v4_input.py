...
ANYFEM_GATE_ROOT_ENVIRONMENT = {
    "ANYFEM_ANY3DVIEW_ROOT": "ANY3dView",
    "ANYFEM_ANYFILEIO_ROOT": "ANYfileIO",
    "ANYFEM_ANYGEOMETRY_ROOT": "ANYgeometry",
    "ANYFEM_ANYMATERIAL_ROOT": "ANYmaterial",
    "ANYFEM_ANYSOLVER_ROOT": "ANYsolver",
    "ANYFEM_ANYTK3D_ROOT": "ANYtk3D",
    "ANYMESHER_SOURCE": "ANYmesh",
}
CANDIDATE_GATE_ROOT_ENVIRONMENTS = {
    "ANYfem": ANYFEM_GATE_ROOT_ENVIRONMENT,
