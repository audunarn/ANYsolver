"""Nonlinear mixed beam density/local solve, isolated author research.

All station origins are fixed throughout a local solve. No committed material
state, production integration, restart or qualification authority is supplied.
The existing elastic F/H/J implementations remain unchanged.
"""
...
from docs.reference_cases.ge_beam3_curved_p5_algebra_probe import HALVES, rotation
...
from docs.reference_cases.ge_beam3_curved_p5_section_probe import (
    DirectedHardeningSectionProbe, SectionHistory, SectionResponse, _history,
)
...
class NonlinearMixedBeamProbe:
    ...
    def solve(self, positions, vertex_frames, *, initial_rotations=None, initial_moments=None,
        ...
        from docs.reference_cases.ge_beam3_curved_p5_algebra_probe import log_rotation
