...
def main():
    ...
    from anysolver._ge_beam3_p5.reference_modal import solve as modal
    from anysolver._ge_beam3_p5.committed_modal import solve_elastic_modes
    ...
    record = dict(schema='GE_BEAM3_P5_INSTALLED_DEVELOPMENT_CHECK_V1',production_qualified=False,
        ...
        restart_exact=True,plastic_exercised=True,
