"""Saved-factor energy-form successor; imports no production mechanics."""
import argparse
...
def run(revision,sign,digits,output):
    ...
    from docs.reference_cases.ge_beam3_spatial_energy_inertia import audit
    ...
    write(root/'energy.json',dict(schema='GE_BEAM3_N24_SAVED_ENERGY_INERTIA_V1',revision=revision,
