"""Bounded private station codec inside the real solver checkpoint envelope.

The inner canonical JSON stays a string so generic JSON normalization cannot
discard signed zero or dataclass identities. Decoding uses fixed schemas only.
"""

import json

from docs.reference_cases.ge_beam3_curved_p5_native_material_probe import canonical, NativeMaterialError
from docs.reference_cases import ge_beam3_curved_p5_restart_probe as schema_source


SCHEMA='GE_BEAM3_P5_NATIVE_TYPED_STATE_JSON_V1'
