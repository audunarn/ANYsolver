#!/usr/bin/env python3
"""Independent SymPy exact oracle for the frozen E4-PL-Q1U study.

There are deliberately four disjoint entry paths:
...
WRAPPER_SCHEMA = "anysolver.s4.e4-pl-q1u-oracle-raw-v1"
...
SUCCESS_TERMINAL = "PROVISIONAL_GO_E4_PL_Q1U_Q1B_PLAN"
LOCAL_NO_GO = "NO_GO_E4_PL_Q1U_LOCAL_ALGEBRA"
PATCH_NO_GO = "NO_GO_E4_PL_Q1U_PATCH_OR_COVARIANCE"
UNCLASSIFIED_TERMINAL = "UNCLASSIFIED_E4_PL_Q1U_LOCAL_PLANAR_IDENTITY"
...
def _execute(inputs: ExecuteInputs) -> dict[str, Any]:
    ...
    try:
        ...
        raise OracleError("output write failed") from exc
    return wrapper
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"Q1U_ORACLE_FAIL_CLOSED: {exc}", file=sys.stderr)
        return 2
