"""Private P5 adapter to native retained-inertia reference-modal assembly.

Not registered by solve_free_vibration or the public element factory. No
prestressed/current-state, transient, joint or general MPC authority is implied.
"""
...
from docs.reference_cases.ge_beam3_curved_p5_algebra_probe import validate_section
