"""Opt-in compensated-position evaluation of the unchanged mixed potential.

The coordinate low part is immutable input to each local solve. Spatial
increments, material equations, station schedule and Schur solve are inherited.
No global controller, commit/restart format or qualification is supplied here.
"""
...
from docs.reference_cases.ge_beam3_curved_p5_nonlinear_mixed_probe import (
    NonlinearMixedBeamProbe, MixedBeamEvaluation, BeamStationTrial,
...
from docs.reference_cases.ge_beam3_curved_p5_compensated_coordinates import split_sum, validate_pair
...
class CompensatedMixedBeamProbe(NonlinearMixedBeamProbe):
