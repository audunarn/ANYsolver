"""Finite P5 lifted kinetic field and analytic inertial derivatives.

Research only: 18 external coordinates plus six *retained* cell spins. Nine
vertex rotation traces have exactly zero inertia. No dynamic condensation,
time integrator, history transaction or production mass policy is supplied.
"""
