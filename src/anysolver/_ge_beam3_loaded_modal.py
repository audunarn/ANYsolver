"""Private loaded-state conservative pencil for the native V4 beam.
...
from anysolver._ge_beam3_p5_loads.core import sha
from anysolver._ge_beam3_p5_loads.state import parameter_value, LOAD_POLICY


POLICY = 'GE_BEAM3_V4_LOADED_HESSIAN_CURRENT_REST_MASS_V1'
