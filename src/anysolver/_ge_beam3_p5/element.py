...
from anysolver._ge_beam3_p5.core import (
...
from anysolver._ge_beam3_p5 import codec as codec


SCHEMA='GE_BEAM3_P5_PACKAGE_DRIVER_STATE_V1'
FORMULATION='CANDIDATE_GE_BEAM3_P5_NATIVE_PACKAGE_V1'
