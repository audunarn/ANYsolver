...
from anysolver._ge_beam3_p5_coordinates.core import (
...
from anysolver._ge_beam3_p5_coordinates import codec as codec
from .positions import POLICY, from_total, station_position


SCHEMA='GE_BEAM3_P5_COORDINATE_DRIVER_STATE_V2'
FORMULATION='CANDIDATE_GE_BEAM3_P5_NATIVE_COORDINATE_V2'
...
class NativeP5BeamElement(Element):
    ...
    def __init__(self, element_id, nodes, reference, section, *, order=8):
        self._core=StationaryCore(element_id, nodes, reference, section, order=order)
    ...
    def compute_nonlinear_response(self, mesh, material, displacement, state=None, num_layers=1,
        ...
        response=self.core._solve(view.trial_coordinates, view.trial_rotation_matrices, previous['histories'], total=total)
