...
from anysolver._ge_beam3_p5_loads.core import (
...
from anysolver._ge_beam3_p5_loads import codec as codec
...
SCHEMA='GE_BEAM3_P5_LOAD_DRIVER_STATE_V4'
FORMULATION='CANDIDATE_GE_BEAM3_P5_NATIVE_LOAD_V4'
