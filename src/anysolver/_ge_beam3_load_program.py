...
SCHEMA = 'GE_BEAM3_NATIVE_FORCE_PROGRAM_CHECKPOINT_V1'
PROGRAM = 'GE_BEAM3_FIXED_PATTERN_FORCE_PROGRAM_V1'
TOLERANCE = 1e-11
        ...
        for index in range(cursor,end):
            ...
            for iteration in range(program.max_iterations+1):
                ...
                for cut in range(program.max_backtracks+1):
                    ...
                    if max(np.linalg.norm(changed[free]),np.linalg.norm(changed_physical[free])) < norm:
