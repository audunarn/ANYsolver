...
def build_capability_matrix(report: Optional[Mapping[str, Any]] = None) -> List[CapabilityEntry]:
    ...
    return [
        CapabilityEntry(
            ...
            limits={
                "shell_formulations": ["Q4", "Q8", "Q8R"],
                "units": "SI",
                "geometry": "flat thin plates within verified mesh and thickness ranges",
            },
            limitations=["Follower pressure, arbitrary contact and unverified material laws are unsupported."],
        ...
        CapabilityEntry(
            ...
            limitations=["Equivalent all-shell model-pair checks must pass before production qualification."],
