"""Private relative-SVD V2 adapter; V1 preserved, no prestress fallback."""
...
from ._native_relative_reference_factor_spectrum import solve_relative_reference_factor_spectrum
from .control import cancellation_safe_point


def solve_relative_virgin_reference_modes(model, element_states, displacement, section_inertias, *,
    ...
    """
    cancellation_safe_point(cancellation_token, 'relative_virgin_reference_modes.start')
    ...
    guard()
    modes = solve_relative_reference_factor_spectrum(elastic, kinetic, packet.free_dofs, packet.algebraic_dofs,
