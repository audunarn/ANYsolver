...
Split equations are imported unchanged from the preserved V5 adapter.
...
from ._native_reassembled_factor_modes import solve_reassembled_factor_modes
...
from ._ge_beam3_seeded_signed_modes import _split
...
class SignedLoadedModes:
    ...
    policy: str = 'GE_BEAM3_V5_REASSEMBLED_SIGNED_LOADED_MODES_V1'
...
def solve_signed_loaded_modes(model, element_states, displacement, section_inertias,
    ...
    result = solve_reassembled_factor_modes(factor, geometric, kinetic, packet.free_dofs,
